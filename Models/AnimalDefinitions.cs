...
public static class AnimalDefinitions
{
    private static readonly Dictionary<AnimalType, AnimalTemplate> _templates = new()
    {
        [AnimalType.Rat] = new(
            ...
            AttackHungerDamage: 0, AttackThirstDamage: 0, AttackHealthDamage: 0f,
        ...
        [AnimalType.DogPack] = new(
            ...
            AttackHungerDamage: 20f, AttackThirstDamage: 10f, AttackHealthDamage: 25f,
        ...
        [AnimalType.Rottweiler] = new(
            ...
            AttackHungerDamage: 25f, AttackThirstDamage: 5f, AttackHealthDamage: 30f,
        ...
        [AnimalType.PitBull] = new(
            ...
            MaxHealth: 50f,
            DetectRadius: 3, AttackRadius: 1, FleeThreshold: 0,
            AttackHungerDamage: 15f, AttackThirstDamage: 15f, AttackHealthDamage: 22f,
        ...
        [AnimalType.Coyote] = new(
            ...
            AttackHungerDamage: 18f, AttackThirstDamage: 8f, AttackHealthDamage: 18f,
        ...
        [AnimalType.Fox] = new(
            ...
            AttackHungerDamage: 0f, AttackThirstDamage: 0f, AttackHealthDamage: 0f,
        ...
        [AnimalType.Deer] = new(
            ...
            AttackHungerDamage: 20f, AttackThirstDamage: 0f, AttackHealthDamage: 12f,
